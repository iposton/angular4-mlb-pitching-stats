...
export class PlayerComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private infoService: InfoService, public router: Router, public location: Location, private http: Http, private firebaseService: FirebaseService) {}
  loadId() {
    ...
    if (this.players != null) {
      ...
      //call everything again and show spinner until this.players = this.infoService.getSentStats(); this is no longer null
